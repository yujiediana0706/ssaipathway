        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <input
              ...
              autoFocus
              className="w-full rounded-xl border border-zinc-300 bg-zinc-50 px-4 py-3 text-sm text-zinc-900 outline-none transition-colors placeholder:text-zinc-400 focus:border-zinc-900 focus:bg-white"
            />
            ...
            <button
              ...
              className="mt-5 w-full rounded-xl bg-zinc-900 py-3 text-sm font-medium text-white transition-colors hover:bg-zinc-700 disabled:cursor-not-allowed disabled:opacity-40"
            >
              {loading ? "验证中…" : "登录"}
            </button>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-zinc-500">
            ...
            <Link
              href="/onboarding"
              className="ml-1 font-medium text-zinc-700 underline-offset-4 hover:text-zinc-900 hover:underline"
            >
              立即创建 →
            </Link>
          </div>
